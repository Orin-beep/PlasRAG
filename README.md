...
In this case, users must provide their own API credentials (via environment variables or configuration files).
...
```
python retrieve.py --query "(not VF1000) and CH2000 and HO4013" --database my_dir
```
...
```
python retrieve.py --query "(not VF1000) and CH2000 and HO4013" --database PlasRAG
``` 
### Output
