...
parser.add_argument('--retrieve_db', help='path of the database folder you want to retrieve the plasmid sequences, default: ./temp', type=str, default='./temp')
inputs = parser.parse_args()
db_path = inputs.database
out_fn = inputs.retrieve_db
